 ...
 */
export declare function zipWith<I extends unknown = unknown>(a2: I[][], fn?: zipWidth_fn_type<I>): I[][];
export declare function maybe_zipWith<I extends unknown = unknown>(a2: I[][], fn?: zipWidth_fn_type<I>): maybe_undefined<I[][]>;
export declare function _default_zipWith_fn<I extends unknown = unknown>(): zipWidth_fn_type<I>;
