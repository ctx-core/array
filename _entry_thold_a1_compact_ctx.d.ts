 ...
 */
export declare const _entry_thold_a1_compact_ctx: thold_a1_compact_ctx_fn_type<unknown>;
export declare const _ctx__compact__a1__thold__entry: thold_a1_compact_ctx_fn_type<unknown>;
