import { a_nowrap_type, wrap_a1_type } from '@ctx-core/function';
/**
 * Array#`concat`, setting falsy values to an empty Array (`[]`).
 */
export declare function concat_truthy_a1<I extends unknown>(a1_nowrap: a_nowrap_type<I>, ...rest_a1: unknown[]): wrap_a1_type<I>;
