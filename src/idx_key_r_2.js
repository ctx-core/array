...
import { idx_key_r_, maybe_idx_key_r_ } from './idx_key_r_.js'
/**
...
export function maybe_idx_key_r_2(item_key_idx_val_ = I__) {
	return (maybe_a, key)=>maybe_idx_key_r_(maybe_a, key, item_key_idx_val_)
