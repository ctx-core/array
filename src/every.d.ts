...
export declare function maybe_every<I extends unknown = unknown, Or = null>(
	maybe_a:readonly I[]|undefined, predicate:(item:I, idx:number, a:readonly I[])=>boolean, or?:Or
):boolean|Or;
