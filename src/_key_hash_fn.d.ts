 ...
 */
export declare function _key_hash_fn</*@formatter:off*/ Val extends Record<string, any> = Record<string, any>, Key extends keyof Val = keyof Val>(key: Key): (a1: Val[]) => Record<string, Val>;
