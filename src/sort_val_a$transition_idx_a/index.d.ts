 ...
 */
export declare function sort_val_a$enter_a_frame_<I extends unknown = unknown>(
 ...
 */
export declare function sort_val_a$enter_a_frame_fn_<I extends unknown = unknown>(
 ...
 */
export declare function sort_val_a$exit_a_frame_<I extends unknown = unknown>(
	sort_val_a?:readonly I[]
):sort_val_a$transition_a_frame_T<I>;
export {
	sort_val_a$enter_a_frame_ as exit_thold_a_compact_ctx_,
 ...
 * Returns a function that returns a [sort_val_a$transition_a_frame_T](#sort_val_a$transition_a_frame_T)
 */
export declare function sort_val_a$exit_a_frame_fn_<I extends unknown = unknown>(
	eq_?:eq__T<readonly I[]>
):sort_val_a$transition_a_frame_fn_T<I>;
export {
