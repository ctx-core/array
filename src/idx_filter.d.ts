 ...
 */
export declare function idx_filter_(is_match_?: is_match_fn_T<number>): (a: number[]) => number[];
export declare function maybe_idx_filter_(is_match_?: is_match_fn_T<number>): (a: number[] | undefined) => number[] | undefined;
export { idx_filter as filter__idx, idx_filter_ as _idx_filter, maybe_idx_filter_ as _maybe_idx_filter, idx_filter_ as _filter__idx, idx_filter_ as _fn__filter__idx, };
