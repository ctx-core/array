 ...
 */
export declare function zip</*@formatter:off*/
	I extends readonly unknown[][] = readonly unknown[][], 
	O extends readonly unknown[][] = readonly I[number][number][][]
>/*@formatter:on*/(a2:I):O;
export declare function maybe_zip<I extends unknown[][] = unknown[][], O extends unknown[][] = I[number][number][][]>(a2:I|undefined):O|undefined;
