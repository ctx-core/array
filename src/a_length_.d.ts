 ...
 */
export declare function a_length_<Val extends unknown = unknown>(a:readonly Val[]):number;
export declare function maybe_a_length$<Val extends unknown = unknown, Or = null>(
