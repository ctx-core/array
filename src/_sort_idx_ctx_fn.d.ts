 ...
 */
export declare function _sort_idx_ctx_fn<I extends unknown = unknown>(compare?: compare_type<I>): sort_idx_ctx_a1_fn_type<I>;
export { _sort_idx_ctx as _fn__sort_idx_ctx, };
