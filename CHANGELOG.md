...
- Updated dependencies
  ...
  - @ctx-core/set@12.1.48

## 26.15.0

### Minor Changes

- sort_idx_o**: aliased by sort_idx_ctx**
- - sort*idx_o*: aliased by sort*idx_ctx*
...
- Updated dependencies
  ...
  - @ctx-core/set@12.1.12

## 26.11.1

### Patch Changes

- 15f224d0f: @ctx-core/set: ^12.1.10 -> ^12.1.11
...
- fix: maybe_reduce: infinite recursion
...
- map_andandfn: explicit return type: Out[]
...
- fix: warning: Conflicting namespaces
